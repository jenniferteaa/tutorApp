...
`,document.head.appendChild(r),document.body.appendChild(t.widget);const i=document.getElementById("main-button");if(!i||!t.widget)return;let s=0,a={x:0,y:0},l=!1,u=!1;function d(g,c){const f=t.widget.offsetWidth,b=t.widget.offsetHeight;return{x:Math.max(0,Math.min(g,window.innerWidth-f)),y:Math.max(0,Math.min(c,window.innerHeight-b))}}function m(g,c){const f=t.widget.offsetWidth,b=t.widget.offsetHeight;return{x:g<window.innerWidth/2?0:window.innerWidth-f,y:Math.max(0,Math.min(c,window.innerHeight-b))}}i.addEventListener("mousedown",g=>{s=Date.now(),a={x:g.clientX,y:g.clientY},l=!1,u=!1;const c=t.widget.getBoundingClientRect();t.dragOffset.x=g.clientX-c.left,t.dragOffset.y=g.clientY-c.top,document.addEventListener("mousemove",p),document.addEventListener("mouseup",y),i&&i.classList.add("dragging")}),i.addEventListener("click",g=>{if(u){u=!1;return}!t.isDragging&&!l&&(g.preventDefault(),g.stopPropagation(),t.isWindowOpen?e():n())});function p(g){const c=Date.now()-s,f=Math.sqrt(Math.pow(g.clientX-a.x,2)+Math.pow(g.clientY-a.y,2));if(!t.isDragging&&(f>3||c>100)&&(t.isDragging=!0,l=!0,document.body.style.cursor="grabbing"),t.isDragging){const b=g.clientX-t.dragOffset.x,M=g.clientY-t.dragOffset.y,S=d(b,M);fe(S.x,S.y),t.lastPosition={x:S.x,y:S.y}}}function y(){if(document.removeEventListener("mousemove",p),document.removeEventListener("mouseup",y),i?.classList.remove("dragging"),document.body.style.cursor="",t.isDragging&&t.widget){u=!0;const g=m(t.lastPosition.x,t.lastPosition.y);t.widget.style.transition="left 0.3s cubic-bezier(0.4, 0, 0.2, 1), top 0.3s cubic-bezier(0.4, 0, 0.2, 1)",fe(g.x,g.y),window.setTimeout(()=>{t.widget&&(t.widget.style.transition="")},300),Re()}t.isDragging=!1,l=!1}}function fe(e,n){if(!t.widget)return;const o=t.widget.offsetWidth||50,r=t.widget.offsetHeight||50,i=Math.max(0,Math.min(e,window.innerWidth-o)),s=Math.max(0,Math.min(n,window.innerHeight-r));t.widget.style.left=`${i}px`,t.widget.style.top=`${s}px`,t.widget.style.right="auto",t.widget.style.bottom="auto",t.widget.style.transform="",t.lastPosition={x:i,y:s}}function j(){t.widget&&(t.widget.style.display="none")}function We(){t.widget&&(t.widget.style.display="block")}async function Re(){}async function Lt(){}function Mt(e){if(!t.widget)return;const n=e.getBoundingClientRect(),o=t.widget.getBoundingClientRect(),r=o.width||50,i=o.height||50,l=n.left+n.width/2<=window.innerWidth/2?10:window.innerWidth-r-10,u=Math.max(10,Math.min(window.innerHeight/2-i/2,window.innerHeight-i-10));fe(l,u),Re()}function Ge(){document.getElementById("tutor-panel")?.remove();const e=document.createElement("div");e.id="tutor-panel",e.classList.add("tutor-panel"),e.innerHTML=`
  ...
  `,e.style.position="fixed",e.style.zIndex="1000000",e.style.left="50%",e.style.top="50%",e.style.right="50%",e.style.bottom="50%",document.body.appendChild(e);const n=40,o=Math.round(window.innerHeight*.38),r=window.innerWidth-e.offsetWidth-20,i=window.innerHeight-e.offsetHeight-20;return e.style.left=`${Math.max(20,Math.min(n,r))}px`,e.style.top=`${Math.max(20,Math.min(o,i))}px`,setTimeout(()=>e.classList.add("open"),10),Ct(e),e}function V(e){t.panelHideTimerId!==null&&(window.clearTimeout(t.panelHideTimerId),t.panelHideTimerId=null),e.classList.remove("closing"),e.style.display="flex",e.classList.add("open")}function At(e){e.classList.remove("open"),e.classList.add("closing"),t.panelHideTimerId!==null&&window.clearTimeout(t.panelHideTimerId),t.panelHideTimerId=window.setTimeout(()=>{e.style.display="none",e.classList.remove("closing"),t.panelHideTimerId=null},180)}function $e(e,n){const o=[".btn-help-mode",".tutor-panel-send",".tutor-panel-prompt",".btn-gotToWorkspace"];for(const r of o){const i=e.querySelector(r);if(i){if(i instanceof HTMLButtonElement){i.disabled=n;continue}if(i instanceof HTMLTextAreaElement){i.disabled=n;continue}i.setAttribute("aria-disabled",n?"true":"false")}}}function X(e,n){const o=[".btn-guide-mode",".btn-help-mode",".tutor-panel-send",".tutor-panel-prompt",".btn-gotToWorkspace"];for(const r of o){const i=e.querySelector(r);if(i){if(i instanceof HTMLButtonElement){i.disabled=n;continue}if(i instanceof HTMLTextAreaElement){i.disabled=n;continue}i.setAttribute("aria-disabled",n?"true":"false")}}}function Ct(e){const{askAnything:n,appendPanelMessage:o,closeTutorPanel:r,handleBackendError:i,highlightAskArea:s,maybeQueueSummary:a,scheduleSessionPersist:l,syncSessionLanguageFromPage:u,workspaceUrl:d}=Oe(),m=e.querySelector(".tutor-panel-close"),p=e.querySelector(".btn-help-mode"),y=e.querySelector(".btn-guide-mode"),g=e.querySelector(".btn-gotToWorkspace");y?.addEventListener("click",()=>{if(!t.currentTutorSession)return;t.currentTutorSession.guideModeEnabled=!t.currentTutorSession.guideModeEnabled;const h=e.querySelector(".btn-guide-mode");if(t.currentTutorSession.userId){const k=t.currentTutorSession.problem,L=Ie(k);rt({enabled:t.currentTutorSession.guideModeEnabled,sessionId:t.currentTutorSession.sessionId,problem_no:L,problem_name:k,problem_url:t.currentTutorSession.problemUrl})}$e(e,!0),e.classList.add("guidemode-active"),t.currentTutorSession.guideModeEnabled?(h?.classList.add("is-loading"),t.guideMessageCount=0,t.lastGuideMessageEl=null,t.guideActiveSlab=null,Pe()):(ie(),t.lastGuideMessageEl&&t.lastGuideMessageEl.classList.add("guide-end"),$e(e,!1),e.classList.remove("guidemode-active"),h?.classList.remove("is-loading")),l(e)}),g?.addEventListener("click",async()=>{if(!d){console.warn("Workspace URL is not set.");return}const h=await at({url:d});i(e,h,{serverMessage:"Unable to open workspace right now.",lockOnServerError:!1})});const c=e.querySelector(".tutor-panel-prompt"),f=e.querySelector(".tutor-panel-send");c?.addEventListener("keydown",async h=>{h.key!=="Enter"||h.shiftKey||(h.preventDefault(),f?.click())}),f?.addEventListener("click",async()=>{if(u(),t.currentTutorSession?.prompt){const h=t.currentTutorSession.prompt;c&&(c.value=""),t.currentTutorSession&&(t.currentTutorSession.prompt=""),o(e,h,"user"),t.currentTutorSession.sessionRollingHistory.qaHistory.push(`user: ${h}`),a(t.currentTutorSession.sessionRollingHistory),l(e),await n(e,h),t.currentTutorSession.prompt="",l(e)}else return s()}),m?.addEventListener("mousedown",h=>{h.stopPropagation()}),m?.addEventListener("click",async()=>r()),p?.addEventListener("click",async()=>{const h=e.querySelector(".btn-help-mode");let k="";t.currentTutorSession&&(t.currentTutorSession.checkModeEnabled=!0,h?.classList.add("is-loading")),X(e,!0),e.classList.add("checkmode-active");try{const L=await Ee();L?.ok&&typeof L.code=="string"&&t.currentTutorSession&&(k=L.code);const R=await pt(e,k);console.log("this is the response: ",R)}catch{}finally{t.currentTutorSession&&(t.currentTutorSession.checkModeEnabled=!1,h?.classList.remove("is-loading")),X(e,!1),e.classList.remove("checkmode-active"),l(e)}}),c?.addEventListener("input",()=>{t.currentTutorSession&&(t.currentTutorSession.prompt=c.value),l(e)});let b=!1,M=0,S=0,C=0,P=0,T=null;const E=.6,Jt=e.querySelector(".tutor-panel-shellbar"),Xe=()=>{if(!b){T=null;return}const h=e.offsetLeft,k=e.offsetTop,L=h+(C-h)*E,R=k+(P-k)*E;e.style.left=`${L}px`,e.style.top=`${R}px`,T=requestAnimationFrame(Xe)},Ke=h=>{if(!b)return;const k=h.clientX-M,L=h.clientY-S,R=window.innerWidth-e.offsetWidth,en=window.innerHeight-e.offsetHeight;C=Math.max(10,Math.min(k,R)),P=Math.max(10,Math.min(L,en)),T===null&&(T=requestAnimationFrame(Xe))},Qe=()=>{b&&(b=!1,document.removeEventListener("mousemove",Ke),document.removeEventListener("mouseup",Qe),T!==null&&(cancelAnimationFrame(T),T=null),e.style.left=`${C}px`,e.style.top=`${P}px`,t.currentTutorSession&&(t.currentTutorSession.position={x:e.offsetLeft,y:e.offsetTop}),l(e))};Jt?.addEventListener("mousedown",h=>{h.preventDefault(),b=!0,M=h.clientX-e.getBoundingClientRect().left,S=h.clientY-e.getBoundingClientRect().top,C=e.offsetLeft,P=e.offsetTop,document.addEventListener("mousemove",Ke),document.addEventListener("mouseup",Qe)})}const Pt={matches:["https://leetcode.com/problems/*"],main(){console.log("🎯 StickyNoteAI v2.2 CSS FIXED + MENU POSITIONING - Loading..."),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{_e()}):_e()}};function _e(){console.log("The widget is being loaded to the page"),t.lastCanonicalProblemUrl=F(window.location.href),gt({appendToContentPanel:ye,scheduleSessionPersist:x,syncSessionLanguageFromPage:v,handleBackendError:O}),ct({appendToContentPanel:ye,scheduleSessionPersist:x,syncSessionLanguageFromPage:v,handleBackendError:O}),It({openTutorPanel:Se,closeTutorPanel:jt,askAnything:Xt,highlightAskArea:Vt,appendPanelMessage:Y,maybeQueueSummary:we,scheduleSessionPersist:x,syncSessionLanguageFromPage:v,handleBackendError:O,workspaceUrl:Bt}),Et(),Lt(),Ot(),Yt(),xt(),He().then(()=>{t.pendingStoredSession?.panelOpen&&Se()}),window.addEventListener("beforeunload",()=>{B(t.currentTutorSession?.element??null)})}function he(e){return!(e.length<8||/\s/.test(e)||!/[A-Z]/.test(e)||!/[a-z]/.test(e)||!/[0-9]/.test(e)||!/[^A-Za-z0-9]/.test(e))}const Ft='#editor button[aria-haspopup="dialog"]';function v(){if(!t.currentTutorSession)return;const e=D();e&&t.currentTutorSession.language!==e&&(t.currentTutorSession.language=e,x(t.currentTutorSession.element??null))}function be(){const e=document.querySelector(Ft);if(e){if(e.dataset.tutorLangListener||(e.dataset.tutorLangListener="true",e.addEventListener("click",()=>{window.setTimeout(v,50)},{passive:!0})),t.languageObserverTarget===e&&t.languageObserver){v();return}t.languageObserver?.disconnect(),t.languageObserverTarget=e,t.languageObserver=new MutationObserver(()=>{v()}),t.languageObserver.observe(e,{childList:!0,characterData:!0,subtree:!0}),v()}}function Ue(e,n,o){const r=o??$(),i=crypto.randomUUID();return{element:e,sessionId:i,userId:n,problem:r,problemUrl:F(window.location.href),language:D(),topics:et(),sessionTopicsInitialized:!1,content:[],prompt:"",position:null,size:null,guideModeEnabled:!1,checkModeEnabled:!1,rollingStateGuideMode:{problem:r,nudges:[],lastEdit:""},sessionRollingHistory:{qaHistory:[],summary:"",toSummarize:[]}}}async function Se(){const e=await le(),n=yt(e),o=e?.userId??"";if(n&&await Be(),t.currentTutorSession&&t.currentTutorSession.element&&document.body.contains(t.currentTutorSession.element)){be(),v(),V(t.currentTutorSession.element),j(),t.isWindowOpen=!0,t.currentTutorSession.element;const i=t.currentTutorSession.element.querySelector(".tutor-panel-content");i&&requestAnimationFrame(()=>{i.scrollTop=i.scrollHeight}),!o||n?(q(t.currentTutorSession.element),W(t.currentTutorSession.element,n?"session expired, please log back in":void 0)):H(t.currentTutorSession),z(),x(t.currentTutorSession.element);return}if(t.currentTutorSession?.userId){$t();try{await B(t.currentTutorSession.element??null,{force:!0})}finally{_t()}}if(!t.pendingStoredSession&&o){const i=await ce(o,$());i&&pe(i,o,F(window.location.href))&&(t.pendingStoredSession=i)}if(t.pendingStoredSession){const i=Ge();Ne(i,t.pendingStoredSession),t.pendingStoredSession=null,be(),v(),V(i),j(),t.isWindowOpen=!0,z(),!o||n?(q(i),W(i,n?"session expired, please log back in":void 0)):t.currentTutorSession&&H(t.currentTutorSession),x(i);return}const r=Ge();if(!r){console.log("There was an error creating a panel");return}t.currentTutorSession=Ue(r,o),be(),v(),V(r),j(),t.isWindowOpen=!0,z(),x(r),t.currentTutorSession&&(!o||n?(q(r),W(r,n?"session expired, please log back in":void 0)):(t.currentTutorSession.userId=o,H(t.currentTutorSession)),setTimeout(()=>{const i=r.querySelector(".tutor-panel-prompt");i&&(i.focus(),i.setSelectionRange(i.value.length,i.value.length))},100))}async function Dt(e){if(t.summarizeInFlight||e.toSummarize.length===0)return;const n=e.toSummarize.splice(0);t.summarizeInFlight=!0;try{const o=await tt({sessionId:t.currentTutorSession?.sessionId??"",summarize:n,summary:e.summary});if(O(t.currentTutorSession?.element??null,o,{silent:!0}))return;const r=typeof o=="string"?o:o?.reply;typeof r=="string"&&(e.summary=r)}finally{t.summarizeInFlight=!1}}function we(e){if(e.qaHistory.length<=40)return;const n=e.qaHistory.splice(0,20);e.toSummarize.push(...n),Dt(e)}async function H(e){if(e.sessionTopicsInitialized||!e.userId)return;(await nt({sessionId:e.sessionId,topics:e.topics}))?.success&&(e.sessionTopicsInitialized=!0,x(e.element??null))}const Bt="http://localhost:3000/auth/bridge",qt=960*60*1e3,Nt=15e3;function Ht(e,n,o){oe();const r=e.querySelector(".tutor-panel-content");r&&(r.innerHTML="");const i=e.querySelector(".tutor-panel-prompt");i&&(i.value=""),t.currentTutorSession=Ue(e,n,o),t.currentTutorSession&&H(t.currentTutorSession)}function z(){t.lastActivityAt=Date.now(),Date.now()-t.lastActivityStoredAt>Nt&&(t.lastActivityStoredAt=Date.now(),x())}async function zt(){if(t.currentTutorSession?.element&&(await B(t.currentTutorSession.element,{force:!0}),t.sessionRestorePending=!0),await Be(),t.currentTutorSession&&(t.currentTutorSession.guideModeEnabled=!1,t.currentTutorSession.checkModeEnabled=!1),t.currentTutorSession?.element){const e=t.currentTutorSession.element;ie(),e.classList.remove("guidemode-active","checkmode-active"),q(e),W(e,"session expired, please log back in")}}function Ot(){const e=()=>z(),n=["mousemove","keydown","click","scroll","input"];for(const o of n)document.addEventListener(o,e,{passive:!0});t.inactivityTimerId&&window.clearInterval(t.inactivityTimerId),t.inactivityTimerId=window.setInterval(async()=>{Date.now()-t.lastActivityAt<qt||!(await le())?.userId||await zt()},6e4)}function Wt(e){t.queue=[],t.flushInFlight=!1,oe(),ie(),e.querySelectorAll(".tutor-panel-assistant-loading").forEach(n=>{n.remove()}),t.currentTutorSession&&(t.currentTutorSession.guideModeEnabled=!1,t.currentTutorSession.checkModeEnabled=!1),e.classList.remove("guidemode-active","checkmode-active"),e.querySelector(".btn-guide-mode")?.classList.remove("is-loading"),e.querySelector(".btn-help-mode")?.classList.remove("is-loading")}function q(e){e.classList.add("tutor-panel-locked"),X(e,!0)}function Ye(e){e.classList.remove("tutor-panel-locked"),X(e,!1)}const je="session expired, please log back in";function Rt(e){return typeof e=="object"&&e!==null&&e.success===!1}function Gt(e){const n=e.querySelector(".tutor-panel-content");if(!n)return;n.querySelectorAll(".tutor-panel-message--assistant").forEach(r=>{r.textContent?.trim()===je&&r.remove()})}function Ve(e,n){const o=e.querySelector(".tutor-panel-content");if(!o)return;const r=Y(e,n,"assistant");r&&(o.scrollTop=r.offsetTop,x(e))}function O(e,n,o){if(!Rt(n))return!1;if(o?.silent)return!0;const r=e??t.currentTutorSession?.element??null;if(!r)return!0;if(n.unauthorized||n.status===401||n.status===403||n.error&&/unauthorized/i.test(n.error))return q(r),W(r,je),t.isWindowOpen||(V(r),j(),t.isWindowOpen=!0,z(),x(r)),Gt(r),!0;if(n.timeout)return Ve(r,o?.timeoutMessage??"The model is taking longer than usual. Please try again."),!0;const i=o?.serverMessage??"Internal server error. Please try again in a moment.";return o?.lockOnServerError===!0&&q(r),Ve(r,i),!0}function $t(){if(document.getElementById("tutor-panel-loading"))return;const e=document.createElement("div");e.id="tutor-panel-loading",e.className="tutor-panel-loading",e.innerHTML='<span class="tutor-panel-loading-spinner"></span><span>Restoring session...</span>',document.body.appendChild(e)}function _t(){document.getElementById("tutor-panel-loading")?.remove()}async function Ut(e){t.currentTutorSession?.userId&&t.currentTutorSession.element&&await B(t.currentTutorSession.element,{force:!0}),t.pendingStoredSession=null,oe();const n=t.isWindowOpen;t.currentTutorSession?.element&&t.currentTutorSession.element.remove(),t.currentTutorSession=null,t.isWindowOpen=!1,We(),await He(),n&&Se()}function Yt(){t.problemUrlWatcherId&&window.clearInterval(t.problemUrlWatcherId),t.problemUrlWatcherId=window.setInterval(()=>{const e=F(window.location.href);e!==t.lastCanonicalProblemUrl&&(t.lastCanonicalProblemUrl=e,Ut())},1e3)}function W(e,n){const o=e.querySelector(".tutor-panel-auth");if(o){if(n){const u=o.querySelector(".auth-error");u&&(u.textContent=n,u.style.display="block")}return}t.suspendPanelOps=!0,Wt(e);const r=document.createElement("div");r.className="tutor-panel-auth",e.appendChild(r);const i=(u,d)=>{if(!u||!d)return;const m=()=>{const p=u.type==="password";d.setAttribute("aria-label",p?"Show password":"Hide password")};d.addEventListener("click",()=>{u.type=u.type==="password"?"text":"password",m(),u.focus(),u.setSelectionRange(u.value.length,u.value.length)}),m()},s=async u=>{const d=t.currentTutorSession?.userId??"",m=t.currentTutorSession?.problem??$();if(t.suspendPanelOps=!1,d&&d===u){t.sessionRestorePending=!1,Ye(e),r.remove(),x(e);return}d&&d!==u&&(await B(e,{force:!0}),Ht(e,u,m));const p=await ce(u,m);p&&pe(p,u,F(window.location.href))?(Ne(e,p),await de(u,p.state.problem),t.pendingStoredSession=null):p&&await de(u,p.state.problem),t.currentTutorSession&&(t.currentTutorSession.userId=u,H(t.currentTutorSession)),t.sessionRestorePending=!1,Ye(e),r.remove(),x(e)},a=u=>{r.innerHTML=`
